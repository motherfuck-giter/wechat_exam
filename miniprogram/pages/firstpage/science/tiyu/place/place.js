  ...
  url: '/pages/index/index',
    ...
    data: {
      ...
      onLoad:function(){
        ...
        const tiyu_place_detail=app.globalData.tiyu_place_detail
        const imgurl=app.globalData.tiyu_place_photo
        const exam=app.globalData.tiyu_place_photo1
        const exam1=app.globalData.tiyu_place_photo2
        const exam2=app.globalData.tiyu_place_photo3
        const exam3=app.globalData.tiyu_place_photo4
        const exam4=app.globalData.tiyu_place_photo5
        this.setData({
          imgurl,
          exam,
          exam1,
        ...
        for(let i=0;i<tiyu_place_detail.length;i++)
        {
          if(tiyu_place_detail[i].value=="1"){
      ...
      chooseImg:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.tiyu_place_photo=imgurl
            that.setData({
              imgurl,
            })
      ...
      chooseImg1:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.tiyu_place_photo1=exam
            that.setData({
              exam,
            })
      ...
      chooseImg2:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.tiyu_place_photo2=exam1
            that.setData({
              exam1,
            })
      ...
      chooseImg3:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.tiyu_place_photo3=exam2
            that.setData({
              exam2,
            })
      ...
      chooseImg4:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.tiyu_place_photo4=exam3
            that.setData({
              exam3,
            })
      ...
      chooseImg5:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.tiyu_place_photo5=exam4
            that.setData({
              exam4,
            })
        ...
        for (let i = 0, lenI = items.length; i < lenI; ++i) {
              ...
              for (let j = 0, lenJ = values.length; j < lenJ; ++j) {
                if (items[i].value === values[j]) {
                  ...
                  tiyu_place_detail[i].value="1"
                  app.globalData.tiyu_place="-1"
                  console.log('----',app.globalData.tiyu_place)
                }
              }
      }
      app.globalData.tiyu_place_detail=tiyu_place_detail
      app.globalData.tiyu_place="-1"
    }
  })
