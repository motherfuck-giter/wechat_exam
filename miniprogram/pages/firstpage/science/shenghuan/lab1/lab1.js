  ...
  url: '/pages/index/index',
    ...
    data: {
      ...
      onLoad:function(){
        ...
        const shenghuan_lab1_detail=app.globalData.shenghuan_lab1_detail
        const imgurl=app.globalData.shenghuan_lab1_photo
        const exam=app.globalData.shenghuan_lab1_photo1
        const exam1=app.globalData.shenghuan_lab1_photo2
        const exam2=app.globalData.shenghuan_lab1_photo3
        const exam3=app.globalData.shenghuan_lab1_photo4
        const exam4=app.globalData.shenghuan_lab1_photo5
        this.setData({
          imgurl,
          exam,
          exam1,
        ...
        for(let i=0;i<shenghuan_lab1_detail.length;i++)
        {
          if(shenghuan_lab1_detail[i].value=="1"){
      ...
      chooseImg:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.shenghuan_lab1_photo=imgurl
            that.setData({
              imgurl,
            })
      ...
      chooseImg1:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.shenghuan_lab1_photo1=exam
            that.setData({
              exam,
            })
      ...
      chooseImg2:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.shenghuan_lab1_photo2=exam1
            that.setData({
              exam1,
            })
      ...
      chooseImg3:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.shenghuan_lab1_photo3=exam2
            that.setData({
              exam2,
            })
      ...
      chooseImg4:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.shenghuan_lab1_photo4=exam3
            that.setData({
              exam3,
            })
      ...
      chooseImg5:function(){
        ...
        wx.chooseImage({
          ...
          success(res) {
              ...
              app.globalData.shenghuan_lab1_photo5=exam4
            that.setData({
              exam4,
            })
        ...
        for (let i = 0, lenI = items.length; i < lenI; ++i) {
              ...
              for (let j = 0, lenJ = values.length; j < lenJ; ++j) {
                if (items[i].value === values[j]) {
                  ...
                  shenghuan_lab1_detail[i].value="1"
      ...
      app.globalData.shenghuan_lab1_detail=shenghuan_lab1_detail
      app.globalData.shenghuan_lab1="-1"
    }
